# Guardrails Engineering (`gre`) — istruzioni di progetto
...
fonte, poi `python3 tools/build_modules.py --module gre`, poi commit qui.

## Cosa cambia rispetto al bundle

- il roster contiene solo le figure di quest'area
- le due skill del core sono rinominate: `gre-profile`, `gre-board`
