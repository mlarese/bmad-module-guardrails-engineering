...
- `gre-board` convoca una review multidisciplinare sullo stesso artefatto; qui si fa prima la
  diagnosi mirata. Passa a `gre-board` solo se il finding attraversa domini o deve entrare in un
  release gate.
