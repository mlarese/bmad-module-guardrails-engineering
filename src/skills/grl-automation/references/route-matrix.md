...
| --- | --- | --- | --- |
| Software | BMM + Otto | Kai, Bruno, Enzo, TEA | test/release `gre-board` |
| Database e persistenza | Dario + BMM Architect | Otto, Bruno, Kai, Enzo, TEA | workload/glossario, ricerca live, benchmark, migrazione e release `gre-board` |
