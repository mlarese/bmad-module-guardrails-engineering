---
name: gre-profile
description: Crea e aggiorna il profilo di progetto del modulo Guardrails. Usa quando l'utente dice "profila il progetto", "crea il profilo Guardrails", "aggiorna il profilo di progetto", invoca "gre-profile", oppure quando una figura Guardrails segnala che il profilo di progetto manca.
---
...
tu sai quali otto cose le quattro figure del modulo devono sapere per non parlare per luoghi
...
regola quanto saranno severe tutte e quattro. La conversazione dura pochi minuti: se sembra un
...
mappatura è nel template) e che le quattro figure ora hanno contesto.
...
- Se cambia la criticità, dillo esplicitamente: cambia la severità di tutte e quattro le figure.
