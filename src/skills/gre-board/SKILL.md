---
name: gre-board
description: Convoca il collegio Guardrails su un artefatto. Usa quando l'utente dice "gre-board", "convoca il collegio", "fai guardare questo alle figure Guardrails", "chi dovrebbe revisionare questo file", "release-gate [path]", o chiede quali rischi il progetto ha già accettato.
---
